...
# Fonte Chaveada e Driver Duplo Isolado para Inversor Monofásico



## Introdução

​		Esse relatório tem a finalidade de analisar, simular, projetar e construir uma fonte chaveada isolada juntamente com drivers isolados afim de ser utilizado em um inversor monofásico, na parte de controle do chaveamento, levando em consideração planilha de custo.

​		~~Ainda em estado de simulação, o foco está na comparação de perdas de potência de chaveamento entre três diferentes esquemas de modulação SPWM: bipolar, unipolar e unipolar alternativo~~



## Objetivos

Elaborar um relatório na qual conste.
...
|   08/09    |                **Desenvolvimento do projeto**                |
|   15/09    |                **Desenvolvimento do projeto**                |
|   22/09    |                **Desenvolvimento do projeto**                |
|   29/09    | **Apresentação dos projetos em formato de prova de conceito** |
|   06/10    |             **Desenvolvimento do projeto final**             |
|   13/10    |             **Desenvolvimento do projeto final**             |
...
​		Circuito representa em um banco de baterias com --- VDC, ligada a um inversor, que conecta a um motor. Nosso projeto se encontra dentro do inversor, pois será a parte de alimentação para os drivers e conexões para o chaveamento.

## Análise do circuito Inversor Monofásico

- Proteções contra overvoltage na entrada;

- Tensão Nominal de Entrada: --- VDC ;
...
- Frequência operação: 20 a 40 kHz;
...
| :------------------------------: | :-----------------: | :--------------------: | :--------: | :-----------: |
|       Driver Duplo Isolado       | 863-NCP51560ABDWR2G |          4,08          |     2      |     8,16      |
| Fonte Chaveada 2 canais Isolados |   919-R15P21503D    |         10,53          |     3      |     31,59     |
|     **Compra total Drivers**     |          -          |           -            |     -      |   **39,75**   |

  Com a cotação do dolar hoje (4/07/2023) está 4,82 o valor final ficaria em 191,60 reais. O valor está bem abaixo em comparação com a Supplier. Contudo, ao montar o driver precisariamos dos optoacopladores que já convertendo os valores da Mouser ficaria em torno de R$40,00. Esses valores apresentados estão sem taxa de importação agregados, mesmo com a taxa inclusa a diferença ainda seria grande.
...
​		O princípio de funcionamento é igual para as duas maneiras, precisamos de uma onda senoidal de entrada e uma onda triangular, esta sendo a modeladora e aquela a referência. Agora com os dois sinais gerados, vamos compará-los entre si e o resultado será o sinal SPWM.
